...
import com.cliqz.browser.vpn.LaunchVPN;
import com.cliqz.browser.vpn.VpnProfile;
import com.cliqz.browser.vpn.api.ExternalAppDatabase;
...
import static com.cliqz.browser.vpn.core.ConnectionStatus.LEVEL_CONNECTED;
import static com.cliqz.browser.vpn.core.ConnectionStatus.LEVEL_WAITING_FOR_USER_INPUT;
...
public class OpenVPNService extends VpnService implements VpnStatus.StateListener, Callback, VpnStatus.ByteCountListener, IOpenVPNServiceInternal {
    public static final String START_SERVICE = "com.cliqz.browser.vpn.START_SERVICE";
    public static final String START_SERVICE_STICKY = "com.cliqz.browser.vpn.START_SERVICE_STICKY";
    public static final String ALWAYS_SHOW_NOTIFICATION = "com.cliqz.browser.vpn.NOTIFICATION_ALWAYS_VISIBLE";
    public static final String DISCONNECT_VPN = "com.cliqz.browser.vpn.DISCONNECT_VPN";
    ...
    public static final String PAUSE_VPN = "com.cliqz.browser.vpn.PAUSE_VPN";
    public static final String RESUME_VPN = "com.cliqz.browser.vpn.RESUME_VPN";
    ...
    synchronized void unregisterDeviceStateReceiver() {
        if (mDeviceStateReceiver != null)
            try {
                ...
                // java.lang.IllegalArgumentException: Receiver not registered: com.cliqz.browser.vpn.NetworkSateReceiver@41a61a10
                // Ignore for now ...
                iae.printStackTrace();
            }
...
//    }
    ...
    private OpenVPNManagement instantiateOpenVPN3Core() {
        try {
            Class cl = Class.forName("com.cliqz.browser.vpn.core.OpenVPNThreadv3");
    ...
    private void doSendBroadcast(String state, ConnectionStatus level) {
        ...
        vpnstatus.setAction("com.cliqz.browser.vpn.VPN_STATUS");
