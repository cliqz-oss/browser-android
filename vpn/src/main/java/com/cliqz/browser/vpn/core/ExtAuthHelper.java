...
import com.cliqz.browser.vpn.api.ExternalCertificateProvider;
...
public class ExtAuthHelper {
    ...
    public static final String ACTION_CERT_CONFIGURATION = "com.cliqz.browser.vpn.api.ExternalCertificateConfiguration";
    public static final String ACTION_CERT_PROVIDER = "com.cliqz.browser.vpn.api.ExternalCertificateProvider";

    public static final String EXTRA_ALIAS = "com.cliqz.browser.vpn.api.KEY_ALIAS";
    public static final String EXTRA_DESCRIPTION = "com.cliqz.browser.vpn.api.KEY_DESCRIPTION";
