    ...
    private final IOpenVPNAPIService.Stub mBinder = new IOpenVPNAPIService.Stub() {
        ...
        private void startProfile(VpnProfile vp)
        {
            ...
            if(vpnPermissionIntent != null || neddPassword != 0){
                ...
                shortVPNIntent.setClass(getBaseContext(), com.cliqz.browser.vpn.LaunchVPN.class);
                shortVPNIntent.putExtra(com.cliqz.browser.vpn.LaunchVPN.EXTRA_KEY, vp.getUUIDString());
                shortVPNIntent.putExtra(com.cliqz.browser.vpn.LaunchVPN.EXTRA_HIDELOG, true);
