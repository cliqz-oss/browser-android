...
public class ExtAuthHelper {
    ...
    public static final String ACTION_CERT_CONFIGURATION = "com.cliqz.library.vpn.api.ExternalCertificateConfiguration";
    public static final String ACTION_CERT_PROVIDER = "com.cliqz.library.vpn.api.ExternalCertificateProvider";

    public static final String EXTRA_ALIAS = "com.cliqz.library.vpn.api.KEY_ALIAS";
    public static final String EXTRA_DESCRIPTION = "com.cliqz.library.vpn.api.KEY_DESCRIPTION";
