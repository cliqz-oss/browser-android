...
import com.cliqz.library.vpn.core.Preferences;
...
public class LaunchVPN {
    ...
    public static final String EXTRA_KEY = "com.cliqz.library.vpn.shortcutProfileUUID";
    public static final String EXTRA_NAME = "com.cliqz.library.vpn.shortcutProfileName";
    public static final String EXTRA_HIDELOG = "com.cliqz.library.vpn.showNoLogWindow";
