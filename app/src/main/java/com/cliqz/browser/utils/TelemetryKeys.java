...
public final class TelemetryKeys {
    ...
    public static final String CURRENT_LAYER = "current_layer";
    public static final String NEXT_LAYER = "next_layer";
    ...
    public static final String ANDROID = "cliqz_android";
    public static final String APP_STATE_CHANGE = "app_state_change";
    public static final String STATE = "state";
    public static final String ONBOARDING_VERSION = "1.0";
    ...
    public static final String ENABLE_JS = "enable_js";
